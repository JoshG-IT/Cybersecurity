...
This repository contains structured **cybersecurity training materials** including **How-Tos**, **Cheat Sheets**, and **Projects** used for educational and demonstration purposes.  
...
| Folder | Description |
|--------|--------------|
| [`/How-Tos`](./How-Tos) | Defensive and offensive security walkthroughs, configuration templates, and best practices. |
| [`/CheatSheets`](./CheatSheets) | Security command references, forensic notes, and SOC quick guides. |
| [`/Projects`](./Projects) | Full hands-on labs and exercises covering Blue Team, Red Team, and SOC analysis. |
